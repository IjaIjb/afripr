  ...
  return (
    <div>
      <section className="text-center">
        <h4 className="md:text-[56px] text-[28px] font-bold text-[#262626]">
          Book a <span className="text-primary">Free Consultation</span>
        </h4>
        <div className="flex justify-center">
          <h5 className="text-center max-w-[668px]">
            AfriProEdu offers free counseling sessions to help prospective
            students navigate their study-abroad plans. These sessions provide
            guidance on program selection, application processes, visa
            requirements, and adapting to life in Abroad
          </h5>
        </div>
          ...
          <div className=" w-full px-4 flex flex-col lg:flex-row lg:justify-between  bg-[#FBFBFC] border border-gray-100 rounded-lg shadow-md sm:p-8">
            ...
            <Marquee direction="right" speed={50}>
              <div className="flex flex-row items-center space-x-5 lg:space-x-10">
                ...
                /> */}
                <a
                  href="https://lab.fi/en/lab-separate-application"
                  rel="noreferrer"
                  target="_blank"
                >
                  <img
                ...
                <a
                  href="https://www.takk.fi/fi/etusivu"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  <img src="/images/vaasa.png" alt="takk" className="w-full" />
                </a>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.lut.fi/fi"
                >
                  <img
                    src="/images/lut1.png"
                    alt="takk"
