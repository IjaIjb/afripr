...
const Testimonial = () => {
  ...
  return (
    <div>
         <section className="lg:block hidden py-12  ">
    ...
    <section className="block lg:hidden py-12  ">
          <div className='md:flex justify-between'>
            <div className='flex md:justify-start justify-center'>
          <h2 className="text-green-600 md:text-start text-center max-w-[200px] leading-[30px] text-[24px] font-bold mb-6">Are you still in doubt?</h2>
          </div>
          {/* <div className="flex md:justify-end justify-center">
            <div>
            <h4 className='max-w-[200px] text-center'>Here are some testimonials from our students</h4>
      ...
      {/* Button */}
      <div className="flex md:justify-end mt-7 justify-center">
            <div>
            {/* <h4 className='max-w-[200px] text-center'>Here are some testimonials from our students</h4> */}
        <button className="bg-green-500 text-white px-6 py-3 rounded-full shadow-md hover:bg-green-600">
          See more reviews →
