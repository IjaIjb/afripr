...
const LoanHome = () => {
  return (
    ...
    <h4 className="absolute text-[#000227]/[5%] md:text-[250px] text-[150px] font-[\'Great Sailor\'] -top-10">05</h4>
      <p className="text-[#000227]/[50%]  text-[20px]">Features</p>
      <h3 className="md:text-[36px] text-[20px] font-bold text-primary">Global Study Loan</h3>
