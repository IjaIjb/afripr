...
<h5 className="text-primary text-[20px] md:text-[32px] font-semibold ">Master’s Degree Psychrometric Test</h5>
                  <div></div>
          </div>
          ...
          <div className="border-b-[5px] border-b-[#1DB459] px-6 pt-16 pb-8 rounded-[10px] shadow-lg border border-[#E5E5E5] flex flex-col justify-between h-full">
            ...
            <h4 className="text-center text-[#1B1C1E] text-[22px] font-medium py-4">Master’s Degree</h4>
            ...
            <div className="flex justify-center mt-auto">
              <Link to="/psychometric-test/masters/questions"
                  state={{ programId }}
...
export default PsychometricTestMasters