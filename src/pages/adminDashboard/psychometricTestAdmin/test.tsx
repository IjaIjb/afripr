      ...
      if (response?.data?.records) {
        ...
        const filteredSubcategories = response.data.records.filter(
          (subcategory: SubCategory) =>
            subcategory.question_types_id === activeProgramId
        );
  ...
  const handleAddOrUpdateSubcategory = async () => {
    ...
    try {
      if (isEditMode) {
        ...
        const response = await AdminApis.updateSubCategory(
        ...
        {loading ? (
          ...
          subcategories.map((subcategory) => (
            <div key={subcategory.id} className="relative">
              <button
                ...
                onClick={() =>
                  handleSubcategoryChange(subcategory.name, subcategory.id)
                }
              >
                {subcategory.name}
              </button>
          ...
          <div className="py-2 px-4 text-gray-500">
            {activeProgramId
              ...
              : "Select a program type to manage subcategories."}
          </div>
        )}
      </div>
            ...
            <div className="flex items-start mb-4">
              ...
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Are you sure you want to delete this subcategory? All
                  associated questions will also be deleted. This action cannot
                  be undone.
                </p>
              </div>
            </div>
