            ...
            <div className="max-w-[2000px] mx-auto lg:px-14 px-3 w-full">
              ...
              <div className="md:px-10">
                <div className="flex justify-center mt-[100px]">
                  ...
                  {/* Right Section */}
                  <div className="w-1/2 bg-white flex flex-col flex-grow md:px-12 px-4 py-6 rounded-r-3xl shadow-md">
                    <div className="flex justify-center mt-20 items-center">
                      <div>
                        ...
                        <h2 className="text-[12px] max-w-[302px] text-[#494949] text-center">
                          Check your email address for instructions to reset
                          your password
                        </h2>
                      </div>
                    </div>
