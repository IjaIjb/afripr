...
const ProgramOverview = () => {
  ...
  // Get ID from URL params first, fallback to location state
  ...
  const handleApply = (id: string, courseName: string) => {
    ...
    // Pass both ID in URL params and state
    navigate(`/application-summary/${formattedCourseName}/${id}`, { state: { id } });
  };
            ...
            <div className="flex justify-center">
              <div className="min-h-screen sm:p-6 pt-[100px] sm:pt-[130px] w-full max-w-[1200px]">
                ...
                <div className="flex justify-center mb-6 sm:mb-10">
                  <div className="h-8 sm:h-10 lg:h-12 w-64 bg-gray-200 rounded-lg animate-pulse"></div>
                </div>
                    ...
                    <div className="mb-4 sm:mb-6">
                      <div className="flex gap-3 mb-4">
                        <div className="flex-1">
                          <div className="h-6 sm:h-7 w-48 bg-gray-200 rounded animate-pulse mb-2"></div>
                      ...
                      <div className="h-6 sm:h-7 lg:h-8 w-full bg-gray-200 rounded animate-pulse mb-4 sm:mb-7"></div>

                      {/* University Image Skeleton */}
                      <div className="relative">
                        <div className="w-full h-48 sm:h-64 lg:h-80 bg-gray-200 rounded-lg animate-pulse"></div>
                        ...
                        <div className="absolute bottom-2 right-2 sm:bottom-3 sm:right-5 bg-white rounded-lg p-2 sm:p-3 shadow-lg">
                          <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 items-center">
                            <div className="flex items-center">
                              <div className="w-4 h-4 sm:w-5 sm:h-5 bg-gray-200 rounded animate-pulse mr-1"></div>
                              <div className="h-4 w-16 bg-gray-200 rounded animate-pulse"></div>
                            </div>
                            <div className="flex gap-2 sm:gap-3 items-center">
                              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-200 rounded animate-pulse"></div>
                              <div className="h-8 sm:h-10 w-16 sm:w-20 bg-gray-200 rounded-full animate-pulse"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="relative bg-[#D7F5DC]/[20%] p-4 sm:p-6 rounded-b-[20px] sm:rounded-b-[31px]">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div className="lg:col-span-2 bg-white relative p-4 sm:p-6 rounded-lg shadow-md">
                      <div className="h-6 sm:h-7 w-48 bg-gray-200 rounded animate-pulse mb-3"></div>
                    ...
                    {/* Academic Requirements Skeleton */}
                    <div className="lg:col-span-2 space-y-4 sm:space-y-6">
                      
                      {/* Academic Requirement Section Skeleton */}
                      <div>
                        <div className="h-6 sm:h-7 w-48 bg-gray-200 rounded animate-pulse mb-2 sm:mb-4"></div>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
                          <div className="sm:col-span-2 bg-white p-3 sm:p-4 rounded-lg shadow">
                            ...
                            <div className="h-6 sm:h-7 bg-gray-200 rounded animate-pulse"></div>
                          </div>
                      ...
                      {/* Language Test Scores Skeleton */}
                      <div>
                        <div className="h-6 sm:h-7 w-56 bg-gray-200 rounded animate-pulse mb-2 sm:mb-4"></div>
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
                          {['IELTS', 'TOEFL', 'PTE', 'DUOLINGO'].map((test, index) => (
                            <div key={index} className="bg-white shadow p-3 rounded-lg text-center">
                              <div className="h-3 w-12 bg-gray-200 rounded animate-pulse mb-1 mx-auto"></div>
                              <div className="h-6 sm:h-7 bg-gray-200 rounded animate-pulse"></div>
                            </div>
                          ))}
                        </div>
                    ...
                    {/* Program Intake Skeleton */}
                    <div>
                      <div className="h-6 sm:h-7 w-40 bg-gray-200 rounded animate-pulse mb-2 sm:mb-4"></div>
                      <div className="p-3 sm:p-4 bg-white rounded-lg min-h-[200px] sm:min-h-[250px] shadow space-y-3">
                        {[...Array(3)].map((_, index) => (
                        ...
                        <div className="border p-3 rounded-lg mt-auto">
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-4">No program ID was provided.</p>
            <button
              onClick={() => navigate('/explore-programs')}
              className="bg-primary text-white px-6 py-2 rounded-full hover:bg-green-600 transition-colors"
            >
              Back to Programs
            </button>
          </div>
                ...
                <div className="relative mx-auto bg-white p-4 sm:p-6 rounded-t-[20px] sm:rounded-t-[31px]">
                  <div className="mb-6">
                    ...
                    <div className="mb-4 sm:mb-6">
                      ...
                      {/* Degree Title */}
                      <h1 className="text-lg sm:text-xl lg:text-2xl font-bold mb-4  break-words">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
                          <div className="sm:col-span-2 bg-white p-3 sm:p-4 rounded-lg shadow">
                            ...
                            <h3 className="text-[#292A2E] text-lg sm:text-xl text-justify lg:text-[18px] font-medium">
                          ...
                          <div className="bg-white p-3 sm:p-4 rounded-lg shadow">
                            ...
                            <h3 className="text-[#292A2E] text-lg sm:text-xl lg:text-[18px] font-medium">
                              {program?.minimum_gpa}
                            </h3>
                          </div>
                        </div>
