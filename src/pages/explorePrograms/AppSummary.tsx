            ...
            <div className="flex justify-center">
              <div className="min-h-screen sm:p-6 pt-[100px] sm:pt-[130px] w-full max-w-[1200px]">
                ...
                <div className="relative bg-white rounded-t-[20px] sm:rounded-t-[31px] px-4 sm:px-6 lg:px-10 py-4 sm:py-6">
                  ...
                  <div className="pt-3">
                    <div className="h-6 sm:h-7 lg:h-8 w-64 bg-gray-200 rounded animate-pulse mb-3"></div>
                ...
                {/* Program Intake & Details Skeleton */}
                <div className="bg-[#D7F5DC]/[20%] px-4 sm:px-6 lg:px-10 py-4 sm:py-6 rounded-b-[20px] sm:rounded-b-[31px]">
                  
                  {/* Course Title Skeleton */}
                  <div className="h-6 sm:h-7 w-48 bg-gray-200 rounded animate-pulse mb-4"></div>

                  {/* Main Content Grid Skeleton */}
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    
                    {/* Program Intake Section Skeleton */}
                    <div className="flex flex-col">
                      <div className="bg-white flex flex-col p-4 sm:p-5 rounded-lg shadow-md h-full">
                        <div className="flex-1 flex flex-col justify-between space-y-3 sm:space-y-4">
                          ...
                          <div className="p-3 sm:p-4 border rounded-lg mt-auto">
                  ...
                  <div className='flex justify-center px-4'>
                    <div className="h-10 sm:h-12 w-32 sm:w-40 bg-gray-200 rounded-full animate-pulse"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center">
              <div className="min-h-screen  sm:p-6 pt-[100px] sm:pt-[130px] w-full max-w-[1200px]">
                ...
                <div className="bg-[#D7F5DC]/[20%] px-4 sm:px-6 lg:px-10 py-4 sm:py-6 rounded-b-[20px] sm:rounded-b-[31px]">
                      ...
                      <div className="bg-white p-4 sm:p-5 rounded-lg shadow-md flex-grow">
                        <div className="space-y-3 sm:space-y-4">
                          ...
                          <div className="flex items-center gap-3 py-2">
                            ...
                            />
                            <div className="min-w-0 flex-1">
                              <h4 className="text-[#000000] text-justify font-semibold text-sm break-words">
                 ...
                 <Link 
                   to={`/degree-application-form/${encodeURIComponent(program?.course)}/${program?.id}`}
