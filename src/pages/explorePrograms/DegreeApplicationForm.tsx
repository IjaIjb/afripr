...
function LUTApplicationForm() {
  ...
  const handleFormSubmit = (e: any) => {
    ...
    if (!userData.first_name || !userData.last_name || !userData.email || 
        !userData.phone_number || !userData.address || !userData.gender || 
        !userData.date_of_birth || !userData.nationality || 
        !userData.country || !userData.native_lang || !langSkills) {
      toast.error('Please fill in all required fields');
      return;
    }
    
    // Show the payment modal instead of submitting directly
    onOpenPaymentModal();
  };
  ...
  const handleSubmit = React.useCallback(
    () => {
      ...
      const applicationData:any = {
        course_id: programId, // Use programId as course_id
        first_name: userData.first_name,
        last_name: userData.last_name,
        other_names: userData.other_name || undefined, // Optional field
        ...
        nin: userData.national_id_no || undefined, // Optional field
        country: userData.country,
        language: userData.native_lang,
        proficiency_in_english: langSkills
      };

      // Remove undefined fields to keep payload clean
      Object.keys(applicationData).forEach(key => 
        applicationData[key] === undefined && delete applicationData[key]
      );

      console.log("Application Data:", applicationData);

      UserApis.degreeCourseApplication(applicationData).then(
        (response: any) => {
          if (response?.data) {
    ...
    [userData, langSkills, scholarship, loader, programId]
  );
        ...
        <div className="bg-[#FBFBFB] sm:px-16 px-6 md:flex md:justify-center items-start pt-10 pb-8">
          <div className=" w-full mx-auto">
            ...
            <div className="flex-col justify-center text-center mt-4">
              ...
              <p>
                Please read these instructions carefully before filling in the
                application form:
              </p>
            </div>
          ...
          <h3 className="text-[16px] font-semibold mb-2 mt-2">
              ...
              <ul className=" space-y-1 text-gray-500 list-disc list-outside pl-4">
                ...
                <li>
                  Please upload the required documents preferably in PDF or JPEG
                  form. Combine all individual pages for each document into the
                  one required document. Make sure the documents are readable
                  and named clearly, for example 'Degree certificate' or
                  'Transcript of records'.
                </li>
                <li>
                  If you fail to provide the required documents when submitting
                  your application, you will receive an email with a personal
                  deadline for supplementing the missing documents. The required
                  documents must be submitted by the given deadline; otherwise
                  we are unable to process your application. No hard copies to
                  be mailed.
                </li>
                <li>
                  You can only submit one (1) application form. If you submit
                  several applications under a different email address, the one
                  submitted first will be taken into consideration. The others
                  will be discarded.
                </li>
              </ul>
            </div>
              ...
              <form onSubmit={handleFormSubmit}>
                ...
                <div className="mb-6 w-full ">
                  <label className="block mb-2 text-sm font-semibold text-[#0A2E04]">
                    ...
                    <p className="text-xs mt-1">
                      (Please ensure that the given email address is typed
                      correctly and is your personal address. Important messages
                ...
                <div className="mb-6 w-full ">
                  <label className="block mb-2 text-sm font-semibold text-[#0A2E04] mt-4">
                    Method for proving your language skills in English
                    <span className="text-[#EE1D52] font-bold">*</span>
                  </label>
                  ...
                  <div className="flex items-center w-full px-4 mb-1 border border-gray-200 rounded ">
                    <input
                      ...
                      onClick={() =>
                        setLangSkills(
                          "C1 Advanced or C2 Proficiency by Cambridge English Qualifications"
                        )
                      }
                    />
                    <label
                    ...
                    >
                      C1 Advanced or C2 Proficiency by Cambridge English
                      Qualifications
                    </label>
                  </div>
                  <div className="flex items-center w-full px-4 mb-1 border border-gray-200 rounded ">
                    <input
                      ...
                      className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 "
                      onClick={() =>
                        setLangSkills("B2 First by Cambridge English")
                      }
                    />
                    <label
                  ...
                  <div className="flex items-center w-full px-4 mb-1 border border-gray-200 rounded ">
                    <input
                      ...
                      name="lang_skills"
                      className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 "
                      onClick={() => setLangSkills("IELTS Academic")}
                    />
                    <label
                      htmlFor="IELTS-test-3"
                      className="w-full py-4 ml-3 text-sm font-medium text-gray-900  "
                    >
                      IELTS Academic
                    </label>
                  ...
                  <div className="flex items-center w-full px-4 mb-1 border border-gray-200 rounded ">
                    <input
                      ...
                      name="lang_skills"
                      className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 "
                      onClick={() => setLangSkills("PTE Academic")}
                    />
                    <label
                      htmlFor="IELTS-test-4"
                      className="w-full py-4 ml-3 text-sm font-medium text-gray-900  "
                    >
                      PTE Academic
                    </label>
                  ...
                  <div className="flex items-center w-full px-4 mb-1 border border-gray-200 rounded ">
                    <input
                      ...
                      className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 "
                      onClick={() =>
                        setLangSkills("TOEFL iBT, TOEFL iBT Home Edition")
                      }
                    />
                    <label
                      htmlFor="IELTS-test-5"
                      className="w-full py-4 ml-3 text-sm font-medium text-gray-900  "
                    >
                  ...
                  <div className="flex items-center w-full px-4 mb-1 border border-gray-200 rounded ">
                    <input
                      ...
                      onClick={() =>
                        setLangSkills(
                          "Degree completed in English at an institution of a higher level of education"
                        )
                      }
                    />
                    <label
                      htmlFor="IELTS-test-6"
                      className="w-full py-4 ml-3 text-sm font-medium text-gray-900  "
                    >
                      Degree completed in English at an institution of a higher
                      level of education in an EU/EEA country, Australia,
                      Canada, Ireland, New Zealand, Switzerland, UK or USA
                    </label>
                  </div>
                  <div className="flex items-center w-full px-4 mb-1 border border-gray-200 rounded ">
                    <input
                      ...
                      onClick={() =>
                        setLangSkills(
                          "Degree completed in English on the upper secondary level of education"
                        )
                      }
                    />
                    <label
                      htmlFor="IELTS-test-7"
                      className="w-full py-4 ml-3 text-sm font-medium text-gray-900  "
                    >
                      Degree completed in English on the upper secondary level
                      of education in an EU/EEA country, Australia, Canada,
                      Ireland, New Zealand, Switzerland, UK or USA
                    </label>
                  </div>
                  <div className="flex items-center w-full px-4 mb-1 border border-gray-200 rounded ">
                    <input
                      ...
                      className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 "
                      onClick={() =>
                        setLangSkills("SAT Evidence-Based Reading and Writing")
                      }
                    />
                    <label
                      htmlFor="IELTS-test-8"
                      className="w-full py-4 ml-3 text-sm font-medium text-gray-900  "
                    >
          ...
          <div className="md:max-w-md  body-font font-poppins">
            <div className="flex flex-wrap mt-4">
              ...
              <p className="text-center text-[#838383] md:text-[14px] text-[12px]">
                Before you proceed , please take a moment to review and accept
                our Terms and Conditions.
              </p>
              <hr className="h-px mb-8 mt-[10px] bg-[#F0F4F9] border-0" />
              <h3 className="md:text-[16px] text-[14px] text-black font-light ">
                <span className="font-bold">Payment:</span> By proceeding, you
                agree to pay 150€ for the Registration fee.
              </h3>
              <h3 className="md:text-[16px] text-[14px] text-black font-light mt-4">
                <span className="font-bold">Refunds:</span> The 150€ being paid
                will be a one time non refundable fee
              </h3>
              <h3 className="md:text-[16px] text-[14px] text-black font-light mt-4">
                <span className="font-bold">Data privacy:</span> Please be aware
                that any information provided will be used to verify your
                identity for future referencing and also for your Visa and
                Residence Permit processing.
              </h3>
              <h3 className="md:text-[16px] text-[14px] text-black font-light mt-4">
                <span className="font-bold">Note:</span> Please be aware that
                AFRIPROEDU does not have the authority to grant admissions to
                students or influence any school's decision to accept them.
                <br /> Our role is to enhance your chances by carefully
                reviewing your documents to ensure they meet the eligibility
            ...
            <div className="flex flex-wrap mt-4">
              ...
              <div className="flex mx-auto space-x-4 mt-6">
                <button
                  ...
                  disabled={loader}
                  className=" text-white bg-[#1DB459] rounded-[5px] font-medium text-sm md:px-5 px-3 md:py-3 py-2.5 mr-2 mb-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loader ? "Submitting..." : "Submit & Pay"}
          ...
          <div className="md:w-[350px] w-[300px]">
            ...
            <div className="flex  mt-5">
              <p className="text-[14px] text-[#898989] ">
                Kindly send your receipt to any of the following platform to
                confirm your payment{" "}
              </p>
            </div>
            <p className="text-[14px] text-[#898989] mt-2">
              If you are unable to make payment in euro, contact the numbers
              below
            </p>
            <div className="mt-5">
